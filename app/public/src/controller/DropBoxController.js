class DropBoxController {
    ...
    removeFolderTask(ref,name){
        return new Promise((resolve,reject)=>{
            //referencia do dataBase - fireBase
            let folderRef = this.getFirebaseRef(ref + '/' + name);

            folderRef.on('value', snapshot=>{
                folderRef.off('value');//desliga o 'ouvinte' do firebase 
                ...
                folderRef.remove();//remove de fato
            });
        });
    }
            ...
            promises.push(new Promise((resolve, reject)=>{
                ...
                if (file.type === 'folder'){
                    ...
                    this.removeFolderTask(this.currentFolder.join('/'), file.name).then(()=>{
                        resolve({fields:{key}});//retorna no mesmo formato esperado pelo chamador do metodo removeTask()
                    });
    ...
    removeFile(ref,name){
        ...
        //referencia do storage no firebase
    ...
    connectFirebase(){
        var firebaseConfig = {
            apiKey: "AIzaSyBn-J8FdZhctQuoWvEUy8WmF7d8SQzpr4E",
            authDomain: "dropbox-clone-3536c.firebaseapp.com",
            databaseURL: "https://dropbox-clone-3536c.firebaseio.com",
            projectId: "dropbox-clone-3536c",
            storageBucket: "dropbox-clone-3536c.appspot.com",
            messagingSenderId: "323653402498",
            appId: "1:323653402498:web:00c123a31aaf3d05ae199b",
            measurementId: "G-0STGEKRLJ8"
          };
          // Initialize Firebase
    ...
    uploadTask(files){//metodo pra fazer o upload dos arquivos ao STORAGE do FIREBASE
        let promises = [];
        ...
        [...files].forEach(file=>{
            ...
            promises.push(new Promise((resolve, reject)=>{
                ...
                let fileRef = storage.ref(this.currentFolder.join('/')).child(file.name);
            
                let task = fileRef.put(file);
                
                //fica ouvindo o progresso do upload do arquivo para o fireBase
                task.on('state_changed',(snapshot)=>{
                //function para o progresso
                    this.uploadProgress({
                ...
                //function para o erro
                    console.error(error);
                    reject(error);
                },()=>{
                //function para o sucesso
                    //pega os dados do arquivo apos ser gravado no servidor
        ...
        li.addEventListener('dblclick',e=>{
            ...
            switch (file.type) {
                ...
                default:
                    ...
                    //monta a url para abrir o arquivo do firebase
                    let url = 'https://firebasestorage.googleapis.com/v0/b/dropbox-clone-3536c.appspot.com/o/'+path.join('')+'?alt=media';
                    window.open(url);
                    break;
            }
        });
